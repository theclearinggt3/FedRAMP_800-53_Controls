...
Gephi_Controls6 <- ddply(Gephi_Controls4,.(Control_Family, Family_Name, Main_Control, Control_Name, Related_Controls),nrow) #%>% 
  #rename(V1 = Weight) %>% 
  #arrange(desc(V1))

Gephi_Controls6 <- rename(Gephi_Controls6, c("V1" = "Weight"))
```
